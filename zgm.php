...
class plgContentZgm extends JPlugin {
			...
			if ($app->isAdmin())
			{
				...
				jQuery( document ).ready(function() {
					var selectedCategory = jQuery("#jform_catid").val(),
							...
							fields = jQuery("#attrib-zgm .controls"),
							labels = jQuery("#attrib-zgm .control-label"),
							warningMessage = jQuery("#attrib-zgm .control-group .zgm_warningMessage");
